...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "shishupal78008@gmail.com";
  ...
  return (
    ...
    (<div
      className={cn(
        "row-span-1 relative rounded-3xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none justify-between flex flex-col space-y-4 border border-white/[0.1] overflow-hidden",
        className
      )}
      style={{
...
{id===3 && (
  <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
    <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
      {['Vue.js','MongoDB','NodeJs'].map((item,i)=>(
        <span
                    key={i}
